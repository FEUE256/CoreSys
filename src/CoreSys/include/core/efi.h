...
EFI_GUID gEfiGraphicsOutputProtocolGuida = {
    0x9042a9de,
    0x23dc,
    0x4a38,
    0x96,
    0x7c,
    {0x01, 0x6f, 0x7c, 0x8f, 0x3b, 0x3a}
};
...
#define EFI_SYSTEM_FAIL 0xFFFFFFFFFFFFFFFFULL 
...
extern const CHAR16 *EFI_ERROR_STRINGS[MAX_EFI_ERROR];
